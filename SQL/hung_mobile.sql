...
INSERT INTO `chi_tiet_don_hang` (`order_id`, `product_name`, `price`, `quantity`, `total_amount`, `customer_id`, `product_id`) VALUES
(19, 'Samsung Galaxy S23 Ultra', '26990000', 1, '26990000', 2, 11),
(19, 'OPPO Reno8 T 5G', '10990000', 2, '21980000', 2, 15),
(20, 'iPhone 13 mini 128GB', '16990000', 7, '118930000', 2, 6),
(22, 'iPhone 14 Pro', '24990000', 2, '49980000', 6, 2),
(22, 'OPPO Reno8 series', '17990000', 2, '35980000', 6, 16);
...
INSERT INTO `danh_muc_san_pham` (`category_id`, `category_name`, `category_description`) VALUES
...
(2, 'samsung', 'Điện thoại Samsung nổi tiếng bởi độ bền cực kỳ cao, giá cả vừa phải nhưng lại có chất lượng tốt, mẫu mã đẹp mắt và đa dạng mức giá từ phổ thông đến cao cấp.'),
(3, 'oppo', 'Điện thoại OPPO mang đến siêu phẩm chụp hình với camera ấn tượng, thiết kế thời thượng cùng phụ kiện công nghệ, được giới trẻ toàn thế giới yêu thích.'),
(4, 'xiaomi', 'Mistore là Cửa hàng Xiaomi chính hãng đầu tiên tại Việt Nam. Trưng bày đầy đủ sản phẩm Xiaomi. Hệ thống cửa hàng Mi store / Mi Việt Nam chuyên bán các sản phẩm chính hãng'),
(5, 'vivo', 'vivo là thương hiệu hàng đầu thế giới về điện thoại thông minh và phụ kiện sáng tạo. Bước tới tương lai với Dòng sản phẩm vivo X80 , vivo V25 , vivo T1 và vivo TWS 2 .');
...
INSERT INTO `don_hang` (`order_id`, `customer_name`, `customer_address`, `customer_email`, `customer_phone`, `total_amount`, `order_date`, `order_status`) VALUES
(19, 'Phạm Anh Dũng', 'Thành phố Hà Nội - Quận Hoàn Kiếm - Phường Hàng Bài - số nhà 7', 'phamanhdung@gmail.com', '0945968152', '48970000', 1683483069, 4),
(20, 'Lê Thị Quỳnh', 'Thành phố Hà Nội - Quận Ba Đình - Phường Giảng Võ - số nhà 7', 'anhdung@gmail.com', '515155152', '118930000', 1683483255, 1),
(21, 'Hà Thành Tùng', 'Tỉnh Quảng Ninh - Huyện Vân Đồn - Xã Đông Xá - nhà số 3', 'hatung@gmail.com', '32515151', '24990000', 1683497987, 1),
(22, 'Lê Thị Quỳnh', 'Tỉnh Hưng Yên - Huyện Văn Giang - Xã Xuân Quan - số 7', 'lequynh123@gmail.com', '0915388515', '85960000', 1683575186, 5);
...
INSERT INTO `khach_hang` (`customer_id`, `customer_name`, `customer_address`, `customer_email`, `customer_phone`, `username`, `password`, `id`) VALUES
(1, 'Nguyễn Phi Hùng', 'Tỉnh Nghệ An - Huyện Tân Kỳ -  Xã Kỳ Sơn -  xóm 12', 'nguyenhungtks1@gmail.com', '0945968013', 'nguyenhungs1', '$2y$10$FdCIG.n9sj7BcU7HdIREwOMqZREZX.4ETUxpnZIhSmYdXvoUX9gpO', 1),
(2, '   Phạm Anh Dũng ', 'Tỉnh Bắc Ninh - Thị xã Từ Sơn -  Phường Châu Khê -  số 13', 'phamanhdung@gmail.com', '051515515', 'anhdung123', '$2y$10$Ku2I8d2gBBo04GTzUoMN8.14xHMbqxzfvM4qov0g09chTXrP3cbPq', 2),
(4, 'Vũ Quang Huy', 'Tỉnh Nghệ An - Huyện Tân Kỳ -  Xã Kỳ Sơn -  xóm 12', 'nguyenhungtks1@gmail.com', '0915388515', 'huy', '$2y$10$CSNkCaezUaj2VR7jkkCCk.ppkVSfiyxqJiQD/Ejp27wqIIddCFcd.', 2),
(5, 'Nguyễn Thị Tố Uyên', 'Thành phố Hồ Chí Minh - Quận 12 -  Phường Thạnh Lộc -  số 7', 'touyen@gmail.com', '0515151221', 'uyen123', '$2y$10$GRTgQGZXKU.WU4p41E2v5urbSuP4q7cyvqxT0Nsfl3jD27Cct5gb6', 2),
(6, 'Lê Thị Quỳnh', 'Tỉnh Hưng Yên - Huyện Văn Lâm -  Thị trấn Như Quỳnh -  xóm 15', 'lequynh123@gmail.com', '0945968013', 'lequynh123', '$2y$10$cQCfGyZTitcnC0BSGWQk6utDreIBJ6ZhhweOUbjG3BlAn.NTujgR.', 2);
...
INSERT INTO `trang_thai` (`order_status`, `status`) VALUES
(1, 'Mới'),
(2, 'Đang xử lý'),
(3, 'Đang vận chuyển'),
(4, 'Hoàn thành'),
...
--
ALTER TABLE `danh_muc_san_pham`
  MODIFY `category_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã danh mục sản phẩm', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `don_hang`
--
ALTER TABLE `don_hang`
  MODIFY `order_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã đơn hàng', AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `khach_hang`
--
ALTER TABLE `khach_hang`
  MODIFY `customer_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã khách hàng', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `san_pham`
--
ALTER TABLE `san_pham`
  MODIFY `product_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã sản phẩm', AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `trang_thai`
--
ALTER TABLE `trang_thai`
  MODIFY `order_status` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã Trạng Thái', AUTO_INCREMENT=6;
